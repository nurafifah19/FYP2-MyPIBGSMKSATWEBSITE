...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo "<script>alert('Maklumat berjaya dikemas kini!'); window.location.href='senaraisukarelawan.php?id=$id';</script>";
    } else {
...
<body>
    ...
    <div class="container">
        ...
        <a href="senaraisukarelawan.php">
            <button class="btn btn-back">Lihat Senarai Sukarelawan</button>
        </a>
    </div>
